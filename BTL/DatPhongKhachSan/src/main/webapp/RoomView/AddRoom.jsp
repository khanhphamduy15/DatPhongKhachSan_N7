...
<body>
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link "
				...
				<ul id="components-nav" class="nav-content collapse show"
					...
					<li><a href="/DatPhongKhachSan/Room" class="active"> <i
						...
						<form action="${pageContext.request.contextPath}/AddRoom"
							...
							<div class="text-center">
								<button type="button" class="btn btn-primary"
									onclick="confirmAddRoom()">Thêm phòng</button>
	...
	<script>
		function confirmAddRoom() {
			...
			const isConfirmed = confirm("Bạn có chắc chắn muốn thêm phòng này không?");
			if (isConfirmed) {
				// Nếu xác nhận, gửi biểu mẫu
