...
<body>
	...
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<div class="d-flex align-items-center justify-content-between">
			<a href="/DatPhongKhachSan/Dashboard" class="logo d-flex align-items-center"> <img
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link " href="/DatPhongKhachSan/Dashboard">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="components-nav" class="nav-content collapse "
					...
					<li><a href="/DatPhongKhachSan/Room"> <i class="bi bi-circle"></i><span>Danh
								sách phòng</span>
					</a></li>
					<li><a href="/DatPhongKhachSan/RoomType"> <i class="bi bi-circle"></i><span>Danh
