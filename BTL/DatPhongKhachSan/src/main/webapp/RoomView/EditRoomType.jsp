			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
						<!-- Vertical Form -->
						<form class="row g-3"
							action="${pageContext.request.contextPath}/EditRoomType"
							method="post">
							<input type="hidden" name="roomTypeID" value="${RoomT.roomTypeID}">
							<div class="col-12 pt-3">
								<label for="input_name" class="form-label">Loại Phòng</label> <input type="text" class="form-control" id="input_name"
									name="roomTypeName" value="${RoomT.roomTypeName}">
							</div>
							<div class="col-12">
								<label for="input_biography" class="form-label">Mô tả</label>
								<input type="text" class="form-control" id="input_biography"
									name="description" value="${RoomT.description}">
							</div>
